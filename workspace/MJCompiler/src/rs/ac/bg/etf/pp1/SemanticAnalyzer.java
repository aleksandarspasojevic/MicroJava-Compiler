...
public class SemanticAnalyzer extends VisitorAdaptor {
	...
	public void visit(ConstNum constNum) {
		report_info("Koriscenje simbolicke konstante " + constNum.getN1() + " na liniji " + constNum.getLine(), null);
	...
	public void visit(CharConst charConst) {
		report_info("Koriscenje simbolicke konstante " + charConst.getC1() + " na liniji " + charConst.getLine(), null);
	...
	public void visit(ConstBool constB) {
		report_info("Koriscenje simbolicke konstante " + constB.getB1() + " na liniji " + constB.getLine(), null);
	...
	public void visit(DesignatorName designator) {
		...
		if(designator.obj.getLevel() == 0) {
			report_info("Globalna promenljiva " + designator.getName() + " na liniji " + designator.getLine(), null);
		}
		else {
			report_info("Lokalna promenljiva " + designator.getName() + " na liniji " + designator.getLine(), null);
		}
	}
	...
	public void visit(DesignatorExpr designatorExpr) {
		...
		Obj obj = designatorExpr.getDesignator1().getDesignator().obj;
...
//		log.info(designatorExpr.obj.getType().getKind());
	}
	...
	public void visit(Const cnst) {
		report_info("Koriscenje simbolicke konstante " + cnst.getN1() + " na liniji " + cnst.getLine(), null);
		cnst.struct = Tab.intType;
	}

	public void visit(CharConstF cnst) {
		report_info("Koriscenje simbolicke konstante " + cnst.getC1() + " na liniji " + cnst.getLine(), null);
		cnst.struct = Tab.charType;
	}

	// uses type from inherited class MyTab
	public void visit(BoolConstF cnst) {
		report_info("Koriscenje simbolicke konstante " + cnst.getB1() + " na liniji " + cnst.getLine(), null);
